...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setSubtitle(" Logged in as "+""+ currentUser.getFullName());
        }
        initUi();
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        startActivity(new Intent(DialogsActivity.this, MainActivity.class));
        finish();
    }
            ...
            switch (requestCode) {
                case REQUEST_SELECT_PEOPLE:
                    ...
                    if(selectedUsers.size()==1){
                        selectedReceiverEmail = selectedUsers.get(0).getLogin();
                        selectedReceiverName = selectedUsers.get(0).getFullName();
                    }else {
                    ...
                    if (isPrivateDialogExist(selectedUsers)) {
                        Log.e("check selected private"," "+new Gson().toJson(selectedUsers));
                        ...
                        Log.e("check selected user new"," "+new Gson().toJson(selectedUsers));
    ...
    private void initUi() {
        ...
        Log.e("user detail"," : "+new Gson().toJson(dialogs));
        ...
        dialogsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Integer opponentId = selectedDialog.getRecipientId();
                QBUser user = QbUsersHolder.getInstance().getUserById(opponentId);
                if(user!=null){
                    try {
                        selectedReceiverEmail = user.getLogin();
                        selectedReceiverName = user.getFullName();
                    }catch (Exception e){
                        selectedReceiverEmail = null;
                        selectedReceiverName = user.getFullName();
                    }
