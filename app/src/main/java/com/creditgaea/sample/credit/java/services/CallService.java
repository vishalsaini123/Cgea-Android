package com.creditgaea.sample.credit.java.services;
...
import com.creditgaea.sample.credit.java.util.NetworkConnectionChecker;
import com.creditgaea.sample.credit.java.utils.Consts;
import com.creditgaea.sample.credit.java.utils.RingtonePlayer;
...
import static com.creditgaea.sample.credit.java.utils.Consts.MAX_OPPONENTS_COUNT;
...
public class CallService extends Service {
    ...
    private Notification initNotification() {
        ...
        builder.setSmallIcon(R.drawable.credit_gaea_logo);

        Bitmap bitmapIcon = BitmapFactory.decodeResource(getResources(), R.drawable.credit_gaea_logo);
