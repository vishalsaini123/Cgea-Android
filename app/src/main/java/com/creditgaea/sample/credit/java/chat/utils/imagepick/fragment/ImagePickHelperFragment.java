package com.creditgaea.sample.credit.java.chat.utils.imagepick.fragment;
...
import com.creditgaea.sample.credit.java.chat.utils.ImageUtils;
import com.creditgaea.sample.credit.java.chat.utils.imagepick.GetFilepathFromUriTask;
...
public class ImagePickHelperFragment extends Fragment {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (isResultFromImagePick(requestCode, resultCode, data)) {
            ...
            new GetFilepathFromUriTask(getChildFragmentManager(),
                    listener, getArguments().getInt(ARG_REQUEST_CODE)).execute(data);
        } else {
