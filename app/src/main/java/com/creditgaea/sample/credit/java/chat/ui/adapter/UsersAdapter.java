...
public class UsersAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.list_item_user_chat
                    , parent, false);
        ...
        holder.userAvatarTitle.setBackgroundDrawable(UiUtils.getColorCircleDrawable(user.getId().hashCode()));
